    ...
    return (
        <>
            <div className="PreFooter">
                <div>
                    {repeatIcon}
                    <p> <b>Hassle-free replacement</b> <br />10-day easy replacement policy on tech.com</p>
                </div>
            ...
            <div className="PreFooter2">
                ...
                <div>
                    ...
                    <a href="https://www.instagram.com/tienda_tech_/?hl=es-la" target= "_blank" >{instagramIcon}</a>
                    <a href="https://www.instagram.com/tienda_tech_/?hl=es-la" target= "_blank" >{facebookIcon}</a>
 {/*                <a href="https://www.instagram.com/tienda_tech_/?hl=es-la" target= "_blank" >{youtubeIcon}</a>
                    <a href="https://www.instagram.com/tienda_tech_/?hl=es-la" target= "_blank" >{twitterIcon}</a>
*/}               </div>
            </div>
            ...
            <div className="footer">
                <div>
                    ...
                    <a href="/"> Warrenty</a>
                    <a href="/">Mi Exchange</a>
                    <a href="/">Bulk Order</a>
                    <a href="/">User Guide</a>
                    <a href="/">Laptop Drivers</a>
                ...
                <div>
                    <p> CONTACT US</p>
                    <a href="https://www.instagram.com/tienda_tech_/?hl=es-la" target= "_blank"> Email</a>
                    <a href="https://www.instagram.com/tienda_tech_/?hl=es-la" target= "_blank">  Quality</a>
                </div>
            ...
            <div className="footerBorder">
                <div> Copyright © 2021 - 2021 <a href="https://www.instagram.com/tienda_tech_/?hl=es-la" target= "_blank">tech.</a> All Rights Reserved</div>
            </div>
